    ...
    this.openModal(this._modalShell({
      ...
      content: `
        ...
        <div class="space-y-3 mb-5">
          <button onclick="AppAuth.loginWithSocial('google')"
            class="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border-2 border-slate-200 hover:border-blue-300 hover:bg-blue-50/30 rounded-xl font-semibold text-slate-700 text-sm transition-all hover:shadow-md active:scale-[0.98]">
          ...
          <button onclick="AppAuth.loginWithSocial('line')"
            class="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#06C755] hover:bg-[#05b34c] rounded-xl font-semibold text-white text-sm transition-all hover:shadow-md active:scale-[0.98]">
        ...
        <div class="relative mb-5">
          ...
          <div class="relative flex justify-center text-xs">
            <span class="bg-white px-3 text-slate-400 font-medium">またはメールアドレスで</span>
          </div>
        </div>
    ...
    this.openModal(this._modalShell({
      ...
      content: `
        ...
        <div class="relative mb-5">
          ...
          <div class="relative flex justify-center text-xs">
            <span class="bg-white px-3 text-slate-400 font-medium">またはメールアドレスで登録</span>
          </div>
        </div>
